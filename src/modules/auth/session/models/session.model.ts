import { LocationInfo, SessionMetadata } from "@/src/shared/types/session-metadata.types";
...
export class LocationModel implements LocationInfo {
    ...
    @Field(() => Number)
    public longetude: number
}

@ObjectType()
export class DeviceModel implements DeviceModel {
    @Field(() => String)
